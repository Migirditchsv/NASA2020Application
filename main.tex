...
## scraps
# Because both policy functions are defined everywhere, if the microscopic MDP cannot generate a solution that converges onto the macroscopic one due to sudden or extreme perturbation from its initial position, the microscopic policy will still productive actions because it encodes 
